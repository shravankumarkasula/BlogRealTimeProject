...
#send_mail('Hello', 'python developer how r u....','kumarshravan67481@gmail.com',['bunnyenugurthi@gmail.com'])
...
def mail_send_view(request,id):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject, message, 'bunnyenugurthi@gmail.com', [cd['to']]) #use[] or ()tuple
            sent=True;
    else:
	    form=EmailSendForm()
